...
allowed_files=(.environment.yaml .git .gitignore .identity.yaml .lane-closeout.md .lane-metadata.yaml .mcp.json .spine-lane-lease.yaml AGENTS.md CLAUDE.md NORTH_STAR.md README.md)
