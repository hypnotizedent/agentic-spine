...
worktree_source_dir="$ROOT/ops/plugins/infra/host/launchd"
...
if [[ -z "$expected_launchd_spine_root" || "$expected_launchd_spine_root" == "null" ]]; then
  if [[ "$contract_source_dir" == */ops/plugins/infra/host/launchd ]]; then
    expected_launchd_spine_root="${contract_source_dir%/ops/plugins/infra/host/launchd}"
  elif [[ "$source_dir" == */ops/plugins/infra/host/launchd ]]; then
    expected_launchd_spine_root="${source_dir%/ops/plugins/infra/host/launchd}"
  fi
fi
if [[ -z "$expected_launchd_spine_root" || "$expected_launchd_spine_root" == "null" ]]; then
