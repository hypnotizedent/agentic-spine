...
PROJECTS_ROOT="$(spine_resolve_peer_repo projects "$SPINE_TARGET_REPO")"
COMMUNICATIONS_BINDINGS_ROOT="${COMMUNICATIONS_BINDINGS_ROOT:-$PROJECTS_ROOT/communications/bindings}"
