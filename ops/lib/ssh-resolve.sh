...
#   ref="$(ssh_resolve_ref "download-stack")"    # => ubuntu@192.168.x.x
#   host="$(ssh_resolve_host "download-stack")"  # => 192.168.x.x
...
# Determines whether this machine has a direct route to the shop LAN (192.168.x.x/24).
