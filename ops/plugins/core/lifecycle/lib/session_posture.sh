...
__SP_CONTRACT_PATH="$SPINE_ROOT/ops/bindings/terminal.role.contract.yaml"
__SP_SSH_TARGETS_PATH="$SPINE_ROOT/ops/bindings/ssh.targets.yaml"
...
__sp_probe_execution_host_state() {
    ...
    local _sp_resolver="${SPINE_ROOT:-$SPINE_ROOT}/ops/lib/ssh-resolve.sh"
