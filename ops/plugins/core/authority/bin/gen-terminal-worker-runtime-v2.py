...
GENERATOR_ID = "ops/plugins/core/authority/bin/gen-terminal-worker-runtime-v2.py"
...
def _render_worker_usage_index(worker_ids: list[str], generated_date: str) -> str:
    lines = [
        ...
        "",
        "This directory is generated by `ops/plugins/core/authority/bin/gen-terminal-worker-runtime-v2.py`.",
        "",
        "## Regenerate",
