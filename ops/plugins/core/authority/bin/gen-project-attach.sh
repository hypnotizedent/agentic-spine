...
Usage:
  ./ops/plugins/core/authority/bin/gen-project-attach.sh
  ./ops/plugins/core/authority/bin/gen-project-attach.sh --check
EOF
}
...
MANAGED_BY = "ops/plugins/core/authority/bin/gen-project-attach.sh"
