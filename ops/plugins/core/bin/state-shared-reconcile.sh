...
RECONCILE_CMD="${RUNTIME_ROOT}/ops/plugins/core/lifecycle/bin/state-shared-reconcile"
...
spine_job_run \
  "state-shared-reconcile:state.shared.reconcile.check" \
  "$RECONCILE_CMD" --check --json
