...
RUNNER="$ROOT/ops/plugins/core/verify/bin/verify-topology"
...
if proposal_path_json="$($RUNNER recommend --json --path ops/plugins/core/proposals/bin/proposals-apply 2>&1)"; then
