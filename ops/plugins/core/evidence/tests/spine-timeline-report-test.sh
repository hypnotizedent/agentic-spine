...
make_repo() {
  ...
  cp "$SP/ops/plugins/core/evidence/bin/spine-timeline-report" "$repo/ops/plugins/core/evidence/bin/spine-timeline-report"
  chmod +x "$repo/ops/plugins/core/evidence/bin/spine-timeline-query"
  chmod +x "$repo/ops/plugins/core/evidence/bin/spine-timeline-report"
