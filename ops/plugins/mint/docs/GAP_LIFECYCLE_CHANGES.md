...
**Location:** Lines 173-283 in `ops/plugins/mint/bin/quote-prepare`
...
**Location:** Lines 285-324 in `ops/plugins/mint/bin/quote-prepare`
...
**Location:** Lines 326-366 in `ops/plugins/mint/bin/quote-prepare`
...
**Test Script:** `ops/plugins/mint/tests/test-quote-resumability.sh`
