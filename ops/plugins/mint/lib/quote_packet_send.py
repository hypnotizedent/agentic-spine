...
def default_preview_bin(spine_root: Path) -> str:
    return str(spine_root / "ops/plugins/communications/bin/communications-send-preview")


def default_execute_bin(spine_root: Path) -> str:
    return str(spine_root / "ops/plugins/communications/bin/communications-send-execute")
