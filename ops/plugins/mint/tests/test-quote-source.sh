...
QUOTE_SOURCE="$SPINE_ROOT/ops/plugins/mint/bin/quote-source"
QUOTE_PRICE="$SPINE_ROOT/ops/plugins/mint/bin/quote-price"
QUOTE_RENDER="$SPINE_ROOT/ops/plugins/mint/bin/quote-render"
FLOW_FIXTURES="$SPINE_ROOT/ops/plugins/mint/tests/fixtures/quote-flow-e2e"
SOURCE_FIXTURES="$SPINE_ROOT/ops/plugins/mint/tests/fixtures/quote-source"
TMP_ROOT="$(mktemp -d)"
