...
CANONICAL_MEDIA_ARCHIVE_ROOT = "pve:/nas-primary/archive/media"
MEDIA_CONTRACT_REQUIRED_PATHS = [
    "pve:/nas-primary/archive/media/movies",
    "pve:/nas-primary/archive/media/tv",
    "pve:/nas-primary/archive/media/music",
]
LEGACY_MEDIA_ARCHIVE_TOKENS = [
    "/nas-primary/archive/media-cold",
    "/nas-primary/media-cold",
    "media-cold/",
]
