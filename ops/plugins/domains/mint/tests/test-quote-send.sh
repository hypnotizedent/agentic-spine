...
QUOTE_SEND="$SPINE_ROOT/ops/plugins/domains/mint/bin/quote-send"
SEND_PREVIEW="$SPINE_ROOT/ops/plugins/domains/communications/bin/communications-send-preview"
