...
PREVIEW_BIN="$ROOT/ops/plugins/domains/communications/bin/communications-send-preview"
EXECUTE_BIN="$ROOT/ops/plugins/domains/communications/bin/communications-send-execute"
ANOMALY_STATUS_BIN="$ROOT/ops/plugins/domains/communications/bin/communications-delivery-anomaly-status"
ANOMALY_DISPATCH_BIN="$ROOT/ops/plugins/domains/communications/bin/communications-delivery-anomaly-dispatch"
