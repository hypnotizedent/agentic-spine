...
(
  out="$(bash "$SP/ops/plugins/domains/media/bin/media-health-check" --json --vm __none__)"
...
(
  out="$(bash "$SP/ops/plugins/domains/media/bin/media-service-status" --json --vm __none__ --service __none__)"
...
(
  out="$(bash "$SP/ops/plugins/domains/media/bin/media-nfs-verify" --json --vm __none__)"
