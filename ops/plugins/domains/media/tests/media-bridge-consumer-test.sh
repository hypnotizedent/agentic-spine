...
cap_scripts=(
  "media.health.check:$SP/ops/plugins/domains/media/bin/media-health-check:--vm __none__"
  "media.service.status:$SP/ops/plugins/domains/media/bin/media-service-status:--vm __none__ --service __none__"
  "media.nfs.verify:$SP/ops/plugins/domains/media/bin/media-nfs-verify:--vm __none__"
)
