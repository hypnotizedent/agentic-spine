...
GENERATOR_ID = "ops/plugins/ops/bin/gen-terminal-worker-runtime-v2.py"
...
def _render_worker_usage_index(worker_ids: list[str]) -> str:
    lines = [
        ...
        "",
        "This directory is generated by `ops/plugins/ops/bin/gen-terminal-worker-runtime-v2.py`.",
        "",
        "## Regenerate",
