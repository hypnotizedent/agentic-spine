...
QUOTE_RECONCILE_PAYMENT_BIN="ops/plugins/mint/bin/quote-reconcile-payment"
QUOTE_PACKET_PAYMENT_RECONCILER="ops/plugins/mint/lib/quote_packet_payment_reconcile.py"
