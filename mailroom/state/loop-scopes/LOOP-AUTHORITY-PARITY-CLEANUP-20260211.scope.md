...
4. Immich added to docker.compose.targets.yaml — pending (this proposal)
5. 6 SERVICE_REGISTRY entries get compose paths — pending (this proposal)
6. Cloudflared probe resolved — pending (P3)
...
| P2 | Spine registry-parity | DONE | CP-20260211-182200 (this proposal) |
| P3 | Cloudflared probe | pending | TBD |
| P4 | Validate + close | pending | TBD |
