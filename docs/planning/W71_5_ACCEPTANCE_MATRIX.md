...
| A5 | parity local=origin=github/share | PENDING | `docs/planning/W71_5_PROMOTION_PARITY_RECEIPT.md` |
| A6 | clean branch status | PENDING | `docs/planning/W71_5_BRANCH_ZERO_STATUS_REPORT.md` |
