...
| ID | Name | Mode | Status |
|----|------|------|--------|
| D257 | resend-mcp-transactional-send-authority-lock | report | PASS |
| D258 | communications-resend-webhook-schema-lock | report | PASS |
| D259 | communications-contacts-governance-lock | report | PASS |
| D260 | communications-broadcast-governance-lock | report | PASS |
| D261 | n8n-resend-direct-bypass-lock | report | REPORT (documented bypass) |
| D262 | communications-resend-expansion-contract-parity-lock | report | PASS |
...
- `ops/bindings/gate.registry.yaml` (UPDATED: +6 gates D257-D262)
...
- `surfaces/verify/d257-resend-mcp-transactional-send-authority-lock.sh` (NEW)
- `surfaces/verify/d258-communications-resend-webhook-schema-lock.sh` (NEW)
- `surfaces/verify/d259-communications-contacts-governance-lock.sh` (NEW)
- `surfaces/verify/d260-communications-broadcast-governance-lock.sh` (NEW)
- `surfaces/verify/d261-n8n-resend-direct-bypass-lock.sh` (NEW)
- `surfaces/verify/d262-communications-resend-expansion-contract-parity-lock.sh` (NEW)
...
- GAP-OP-1026: n8n A01 workflow still calls Resend API directly. D261 reports the bypass but does not block (report mode). Migration to official n8n Resend node or spine capability deferred to next wave.
- D257-D262: all in report mode. Promotion to enforce deferred until n8n bypass is remediated.
