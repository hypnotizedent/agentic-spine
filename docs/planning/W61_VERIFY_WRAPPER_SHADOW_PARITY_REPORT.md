...
|---|---|---|---|---|---|
| `fast` | `CAP-20260227-215731__verify.run__Rcax889244` | total=15 pass=15 fail=0 | total=15 pass=15 fail=0 | total_delta=0, pass_delta=0, fail_delta=0, wrapper_only_failures=[], legacy_only_failures=[] | PASS |
| `domain communications` | `CAP-20260227-215734__verify.run__Rok4g88361` | total=47 pass=47 fail=0 | total=47 pass=47 fail=0 | total_delta=0, pass_delta=0, fail_delta=0, wrapper_only_failures=[], legacy_only_failures=[] | PASS |
