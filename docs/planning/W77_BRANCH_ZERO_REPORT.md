# W77 Branch Zero Report

cleanup_token_present: false
cleanup_execution: report-only

## Summary by Repo

| repo | total_codex_branches | KEEP_OPEN | MERGED_SAFE_DELETE | CHERRY_PICK_REQUIRED | ARCHIVE_ONLY |
|---|---:|---:|---:|---:|---:|
| agentic-spine | 6 | 1 | 2 | 3 | 0 |
| workbench | 8 | 1 | 2 | 5 | 0 |
| mint-modules | 8 | 1 | 1 | 6 | 0 |

## Classification Matrix

| repo | branch | class | ahead_of_main | behind_main | local | origin | github | share | reason |
|---|---|---|---:|---:|---|---|---|---|---|
| agentic-spine | codex/w68-outcome-burndown-20260228 | CHERRY_PICK_REQUIRED | 15 | 65 | aef497f47284 | aef497f47284 | aef497f47284 | aef497f47284 | contains commits not merged to main |
| agentic-spine | codex/w73-unassigned-gate-triage-20260228 | CHERRY_PICK_REQUIRED | 3 | 21 | 165124fe6d4d | 165124fe6d4d | 165124fe6d4d | 165124fe6d4d | contains commits not merged to main |
...
| workbench | codex/w64-backlog-throughput-closure-20260228 | CHERRY_PICK_REQUIRED | 1 | 1 | a2e7caccaaa1 | a2e7caccaaa1 | a2e7caccaaa1 | - | contains commits not merged to main |
...
| mint-modules | codex/w64-backlog-throughput-closure-20260228 | CHERRY_PICK_REQUIRED | 1 | 2 | cceb95684555 | cceb95684555 | cceb95684555 | - | contains commits not merged to main |
