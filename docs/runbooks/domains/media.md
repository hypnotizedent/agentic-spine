...
2. Review `/Users/ronnyworks/code/projects/media/bindings/media.path.authority.contract.yaml`, `/Users/ronnyworks/code/projects/media/bindings/media.archive.flow.policy.yaml`, and `/Users/ronnyworks/code/projects/media/bindings/media.quality.policy.yaml` before touching any historical migration packet or profile policy.
