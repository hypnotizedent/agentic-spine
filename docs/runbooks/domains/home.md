...
## Scope
Primary recovery flow for domain `home`.

## Detect
1. `./bin/ops cap run spine.log.query -- --since-hours 24 --domain home --status failed`
2. `./bin/ops cap run verify.run -- domain home`
