...
- ops/bindings/secrets.inventory.yaml :: lifecycle value 'overloaded' not allowed by conventions
- ops/bindings/secrets.inventory.yaml :: lifecycle value 'overlaps' not allowed by conventions
...
- ops/bindings/vm.lifecycle.yaml :: status value 'template' not allowed by conventions
- ops/bindings/vm.operating.profile.yaml :: disallowed key 'vmid' found
- ops/bindings/vm.operating.profile.yaml :: disallowed key 'notes' found
- ops/bindings/z2m.naming.yaml :: disallowed key 'notes' found
...
- ops/bindings/vm.lifecycle.yaml :: legacy key 'vmid' allowed by exception (not changed)
- ops/bindings/vm.lifecycle.yaml :: legacy key 'notes' allowed by exception (not changed)
