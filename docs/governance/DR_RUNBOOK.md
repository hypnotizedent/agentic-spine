...
authority_path: "docs/infrastructure/domains/recovery/DR_RUNBOOK.md"
route_binding: "ops/bindings/domain.docs.routes.yaml"
---

# DR_RUNBOOK.md (Pointer)

Canonical domain document moved to:
"/Users/ronnyworks/code/workbench/docs/infrastructure/domains/recovery/DR_RUNBOOK.md"
