...
authority_path: "agents/finance/docs/FINANCE_LEGACY_EXTRACTION_MATRIX.md"
route_binding: "ops/bindings/domain.docs.routes.yaml"
---

# FINANCE_LEGACY_EXTRACTION_MATRIX.md (Pointer)

Canonical domain document moved to:
"/Users/ronnyworks/code/workbench/agents/finance/docs/FINANCE_LEGACY_EXTRACTION_MATRIX.md"
