...
- Backup: recoverable copies of canonical state. Canonical roots: `/srv/backups/<stack>/...`, `pve:/nas-primary/backup-cold/...`, `synology918:/volume1/backups/...`.
- Archive: retained cold payload not needed for normal runtime. Canonical roots: `pve:/nas-primary/archive/...`, `/srv/archive/<stack>/...` when no shared archive plane exists.
- Tombstone / Retired: dead runtime kept only for recovery, extraction, or evidence. Canonical roots: `pve:/nas-primary/tombstones/...` and documented cold restore artifacts such as `vm-200-docker-host-primary`.
...
- Canonical examples:
  ...
  - `pve:/nas-primary/archive/live-share/ronny-projects` -> direct pve access (archive-smb LXC export retired 2026-04-14)
  - `pve:/nas-primary/archive/live-share/mint-legacy` -> direct pve access (archive-smb LXC export retired 2026-04-14)
...
- `/nas-primary/backup-cold` = canonical shop cold backup plane
- `/nas-primary/archive` = canonical shop cold archive plane
- `/nas-primary/stage` = controlled staging, import, and reconciliation lane
- `/nas-primary/tombstones` = retired runtime residue and post-cleanup evidence lane
