...
| surveillance-stack | `surveillance-stack` | 192.168.1.215 | 215 | — | Frigate/go2rtc surveillance platform. Tailscale: 100.89.1.111. |
| archive-smb | `archive-smb` | 192.168.1.217 | 220 | — | Archive SMB file-plane LXC on shop LAN. |
