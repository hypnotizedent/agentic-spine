...
authority_path: "agents/immich/docs/IMMICH_LEGACY_EXTRACTION_MATRIX.md"
route_binding: "ops/bindings/domain.docs.routes.yaml"
---

# IMMICH_LEGACY_EXTRACTION_MATRIX.md (Pointer)

Canonical domain document moved to:
"/Users/ronnyworks/code/workbench/agents/immich/docs/IMMICH_LEGACY_EXTRACTION_MATRIX.md"
