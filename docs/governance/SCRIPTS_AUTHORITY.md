...
| `infisical-agent.sh` | Canonical: `/Users/ronnyworks/code/agentic-spine/ops/tools/infisical-agent.sh` (workbench shim: `scripts/agents/infisical-agent.sh`) | Secrets management with caching |
