...
authority_path: "docs/infrastructure/domains/shop/SHOP_SERVER_SSOT.md"
route_binding: "ops/bindings/domain.docs.routes.yaml"
---

# SHOP_SERVER_SSOT.md (Pointer)

Canonical domain document moved to:
"/Users/ronnyworks/code/workbench/docs/infrastructure/domains/shop/SHOP_SERVER_SSOT.md"
