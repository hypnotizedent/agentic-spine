...
**Mint product work lives in [`mint-modules`](https://github.com/your-github-user/mint-modules), not in spine.**
...
`$SPINE_RUNTIME/spine/state/mint/`), unregistered bins (51 scripts in
