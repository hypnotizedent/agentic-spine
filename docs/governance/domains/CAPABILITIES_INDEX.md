...
| `immich` | 2 | `docs/governance/domains/immich/CAPABILITIES.md` |
| `media` | 8 | `docs/governance/domains/media/CAPABILITIES.md` |
| `mint` | 6 | `docs/governance/domains/mint/CAPABILITIES.md` |
| `ms-graph` | 10 | `docs/governance/domains/ms-graph/CAPABILITIES.md` |
