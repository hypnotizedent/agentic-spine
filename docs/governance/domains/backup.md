...
- `nas-primary/backup-cold/...` is the shop cold backup plane for app/state and promoted shop VM/LXC copies.
...
- Canonical recipient for backup receipts and backup-monitor alerts: `backups@spine.example.com`
- Runtime implementation: Stalwart alias to `alerts@spine.example.com`
