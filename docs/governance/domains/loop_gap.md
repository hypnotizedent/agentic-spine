...
Canonical domain policy for `loop_gap`.

- Authority: `docs/governance/SPINE.md`
- Runtime contracts: `ops/bindings/domains/loop_gap.bundle.yaml`
- Scoped domain health readback: `./bin/ops cap run verify.run -- domain loop_gap`
...
_No domain-external capabilities currently map to `loop_gap`._
