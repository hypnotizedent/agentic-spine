...
| [CORE_LOCK.md](core/CORE_LOCK.md) | Spine health invariants + drift gate definitions (D1-D68) |
...
| [ORCHESTRATION_CAPABILITY.md](governance/ORCHESTRATION_CAPABILITY.md) | Machine-enforced loop orchestration contract (manifest, validation, integrate) |
