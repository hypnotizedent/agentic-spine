...
Evidence set:
- Existing ownership SSOT: `$HOME/code/mint-modules/docs/ARCHITECTURE/DATABASE_OWNERSHIP.md:20-60`
- Legacy migrations: `$HOME/ronny-ops/mint-os/apps/api/migrations/*.sql`
- Mint migrations: `$HOME/code/mint-modules/*/migrations/*.sql`
- Legacy order/auth/payment runtime writes: `$HOME/ronny-ops/mint-os/apps/api/routes/v2-jobs.cjs`, `$HOME/ronny-ops/mint-os/apps/api/routes/auth.cjs`, `$HOME/ronny-ops/mint-os/apps/api/routes/admin-auth.cjs`, `$HOME/ronny-ops/mint-os/apps/api/routes/employee.cjs`, `$HOME/ronny-ops/mint-os/apps/api/routes/stripe-webhooks.cjs`, `$HOME/ronny-ops/mint-os/apps/api/routes/v2-checkout.cjs`
- Artwork legacy-compat writes: `$HOME/code/mint-modules/artwork/src/services/db.ts:186-446`
