...
Evidence:
- Legacy lifecycle surface: `$HOME/ronny-ops/mint-os/apps/api/routes/v2-jobs.cjs` (4347 lines)
- V1 scope lock: `$HOME/code/mint-modules/docs/ARCHITECTURE/V1_SCOPE_AND_ROUTE_CANON.md:14-33`, DNB1 at `:67-78`
- Order-intake scope: `$HOME/code/mint-modules/order-intake/API.md:38-133`, `$HOME/code/mint-modules/order-intake/src/app.ts:61-63`
...
- n8n webhook: `fetch('https://n8n.example.com/webhook/mint/payment', ...)` (`v2-jobs.cjs:1614-1630`)
