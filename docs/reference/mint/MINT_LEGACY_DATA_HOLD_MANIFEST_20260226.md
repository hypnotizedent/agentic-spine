...
Filesystem context:
- `/mnt/docker` is NFS (`192.168.x.x:/tank/docker`)
...
Receipts:
1. `$SPINE_ROOT/receipts/sessions/RCAP-20260226-030950__session.start__Reocl31228/receipt.md`
2. `$SPINE_ROOT/receipts/sessions/RCAP-20260226-031009__infra.docker_host.status__Ryof841008/receipt.md`
3. `$SPINE_ROOT/receipts/sessions/RCAP-20260226-031009__docker.compose.status__R9jjw41011/receipt.md`
4. `$SPINE_ROOT/receipts/sessions/RCAP-20260226-031009__services.health.status__Rvpbn41018/receipt.md`
5. `$SPINE_ROOT/receipts/sessions/RCAP-20260226-031009__cloudflare.tunnel.ingress.status__Rfap541023/receipt.md`
