...
## Current Counter Snapshot (2026-02-28 UTC)
...
|-----|----------|---------|
| **GAP-OP-037** — MD1400 SAS shelf invisible (switch-primary PCI ID mismatch) | critical | Maintenance window + cold power cycle required (all 10 VMs down) |
...
`$HOME/ronny-ops/.brain/memory.md`
