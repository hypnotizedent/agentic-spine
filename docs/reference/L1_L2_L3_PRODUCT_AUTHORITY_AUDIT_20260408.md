...
|---|---|
| mint/comms | d216 (example-shop DNS), d218 (example-shop.com DNS), d219 (hantash DNS), d222 (quote alert boundary), d233 (mail archiver storage), d392 (mail policy), d399 (customer mailbox) |
...
|---|---|---|
| `surfaces/verify/d216-example-shop-mail-dns-parity-lock.sh` | mint/comms | extract |
| `surfaces/verify/d218-example-shop-co-mail-dns-parity-lock.sh` | mint/comms | extract |
