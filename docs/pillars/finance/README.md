...
| Document | Path | Scope |
|----------|------|-------|
| Stack Architecture | `docs/legacy/brain-lessons/FINANCE_STACK_ARCHITECTURE.md` | Service topology, compose, volumes |
| SimpleFIN Pipeline | `docs/legacy/brain-lessons/FINANCE_SIMPLEFIN_PIPELINE.md` | Bank sync, account mapping |
| n8n Workflows | `docs/legacy/brain-lessons/FINANCE_N8N_WORKFLOWS.md` | Automation workflows |
| Backup & Restore | `docs/legacy/brain-lessons/FINANCE_BACKUP_RESTORE.md` | DB backup/restore procedures |
| Account Topology | `docs/legacy/brain-lessons/FINANCE_ACCOUNT_TOPOLOGY.md` | 21-account registry |
| Deploy Runbook | `docs/legacy/brain-lessons/FINANCE_DEPLOY_RUNBOOK.md` | Deployment procedures |
| Reconciliation | `docs/legacy/brain-lessons/FINANCE_RECONCILIATION.md` | Sync gap detection |
| Troubleshooting | `docs/legacy/brain-lessons/FINANCE_TROUBLESHOOTING.md` | Debug procedures |
